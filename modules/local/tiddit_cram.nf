...
process TIDDIT_CRAM {
    ...
    """
    tiddit --sv -o TIDDIT_${meta} --bam ${cram} --ref ${fasta}
    mv TIDDIT_${meta}.vcf TIDDIT_${meta}.old.vcf
    grep -E "#|PASS" TIDDIT_${meta}.old.vcf > TIDDIT_${meta}.vcf

    """
}
// #bgzip --threads ${task.cpus} -c TIDDIT_${meta}.vcf > TIDDIT_${meta}.vcf.gz
    // #tabix TIDDIT_${meta}.vcf.gz
